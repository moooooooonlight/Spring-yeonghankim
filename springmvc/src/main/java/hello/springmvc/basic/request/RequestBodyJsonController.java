...
public class RequestBodyJsonController {
    ...
    public String requestBodyJonV3(@RequestBody HelloData helloData) throws IOException {
        log.info("username={} age={}",helloData.getUsername(),helloData.getAge());

        return "ok";
    }
    @ResponseBody
    @PostMapping("/model-attribute-v4")
    public String requestBodyJonV4(HttpEntity<HelloData> data){
